...
public final class EventDispatchThreadHangMonitor extends EventQueue {
    ...
    private static final long UNREASONABLE_DISPATCH_DURATION_MS = 200;
        ...
        private static void runExceptionTest(final JFrame frame) {
            ...
            button.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    throw new RuntimeException("Nobody expects the Spanish Inquisition!"); // NOPMD by tw on 15.05.11 22:47
                }
            });
            frame.add(button);
        }
